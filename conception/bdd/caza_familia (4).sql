...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 10 avr. 2025 à 11:14
...
-- Fonctions
--
DROP FUNCTION IF EXISTS `renvoie_somme_produit`$$
...
(32, 5, 0, '2025-04-10 09:47:25', 22.00, 0),
(33, 5, 0, '2025-04-10 09:54:47', 66.00, 0),
(34, 5, 0, '2025-04-10 09:59:24', 39.60, 0),
(35, 5, 0, '2025-04-10 10:02:27', 8.44, 1),
(36, 5, 0, '2025-04-10 10:03:41', 8.44, 1),
(37, 5, 0, '2025-04-10 10:07:37', 4.22, 1),
(41, 3, 0, '2025-04-10 10:37:16', 46.42, 1),
(42, 3, 0, '2025-04-10 10:39:19', 91.79, 1);
...
INSERT INTO `lignecommande` (`id_ligne_commande`, `id_commande`, `id_produit`, `qte`, `total_ligne_ht`, `vegan`) VALUES
(1, 2, 5, 3, 45.00, 0),
(2, 2, 6, 3, 42.00, 0),
(3, 2, 10, 1, 14.00, 0),
(4, 2, 11, 1, 14.00, 0),
...
--
ALTER TABLE `commande`
  MODIFY `id_commande` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT pour la table `lignecommande`
--
ALTER TABLE `lignecommande`
  MODIFY `id_ligne_commande` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
