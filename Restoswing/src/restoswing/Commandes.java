...
public class Commandes {
    ...
    public Commandes(int id_commande, int id_user, int id_etat, String _date, String total_commande, String login, int type_conso, int total_nb_produit, ArrayList libelle) {
